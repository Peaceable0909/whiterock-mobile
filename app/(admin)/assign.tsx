...
const mkS = (C: ColorPalette) => StyleSheet.create({
  ...
  banner:          { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: C.blue + '18', padding: 12, paddingHorizontal: 16, borderBottomWidth: 1, borderColor: C.blue + '35' },
  ...
  assignedBadge:   { backgroundColor: C.green400 + '30', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  assignedText:    { fontSize: 10, fontWeight: '700', color: '#059669' },
  unassignedBadge: { backgroundColor: C.orange500 + '30', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  unassignedText:  { fontSize: 10, fontWeight: '700', color: C.orange500 },
