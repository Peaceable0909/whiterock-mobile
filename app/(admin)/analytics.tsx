...
const mkS = (C: ColorPalette) => StyleSheet.create({
  ...
  newSignupsCard:  { flexDirection: 'row', alignItems: 'center', backgroundColor: C.green400 + '18', borderRadius: 14, padding: 16, marginTop: 16, borderWidth: 1, borderColor: C.green400 + '40' },
  newSignupsLeft:  { flex: 1 },
  newSignupsNum:   { fontSize: 26, fontWeight: '900', color: C.green400 },
  newSignupsLabel: { fontSize: 12, color: C.green400, marginTop: 2 },
  newSignupsBadge: { width: 44, height: 44, backgroundColor: C.green400 + '30', borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
