    ...
    <View style={[s.bg, { paddingTop: insets.top }]}>
      ...
      <View style={s.center}>
        <View style={[s.iconBox, { backgroundColor: '#F0FDF4' }]}>
          <Ionicons name="school-outline" size={38} color="#059669" />
        </View>
        <Text style={s.heading}>Coming Soon</Text>
        <Text style={s.body}>
          View conditional and unconditional offers from UK universities, track deadlines, and manage your decisions in one place.
        </Text>
      </View>
    </View>
  )
